...
Thank you for your interest in improving the **Offline AI for Indian Legal Information (Rural)** studio resources! 🎉
...
# 2. Clone your fork
git clone https://github.com/YOUR_USERNAME/tp-offline-rural-legal-advisor.git
...
Generated configurations come from the **[Offline AI for Indian Legal Information (Rural) Studio](https://pradeeptalari14.github.io/portfolio/tools/offline-rural-legal-advisor/)**.
