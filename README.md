# ⚖️ Offline AI for Indian Legal Information (Rural)

> Offline application for searching Indian Evidence Act indices. Includes local SMS export options.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/offline-rural-legal-advisor/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-offline-rural-legal-advisor.git
cd tp-offline-rural-legal-advisor
```
...
```bash
kubectl port-forward deployment/tp-offline-rural-legal-advisor 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
```text
tp-offline-rural-legal-advisor/
...
└── primary_config/
    └── offline_legal_advisor.py     # Main configuration file
```
...
---
*Generated by [Offline AI for Indian Legal Information (Rural) Studio](https://pradeeptalari14.github.io/portfolio/tools/offline-rural-legal-advisor/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
